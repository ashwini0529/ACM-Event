...
function addNewQuestion($questionTitle, $questionDescription, $questionMarks, $questionType,$whoAdded){
	 global $mysqli,$db_table_prefix;
	...
	$stmt->bind_param("sssss", $questionTitle, $questionDescription, $questionMarks, $questionType,$whoAdded);
	$stmt->execute();
	$stmt->close();
...
function fetchQuestions(){
  ...
  <div class="panel-body">
	...
	<a href = "uploadSolution.php?id='.$id.'">Click here to attempt the Question</a>
  </div>
</div>
<br>
